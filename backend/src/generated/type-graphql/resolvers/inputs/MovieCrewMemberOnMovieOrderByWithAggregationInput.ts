...
export class MovieCrewMemberOnMovieOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field(
    (_type) => MovieCrewMemberOnMovieCountOrderByAggregateInput,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => MovieCrewMemberOnMovieMaxOrderByAggregateInput,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => MovieCrewMemberOnMovieMinOrderByAggregateInput,
    {
      nullable: true,
    },
  )
