...
export class MovieCrewMemberOnMovieUpdateManyWithoutMovieNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieCrewMemberOnMovieUpsertWithWhereUniqueWithoutMovieInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieCrewMemberOnMovieUpdateWithWhereUniqueWithoutMovieInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieCrewMemberOnMovieUpdateManyWithWhereWithoutMovieInput],
    {
      nullable: true,
    },
  )
