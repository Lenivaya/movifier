...
export class MovieListUpdateOneRequiredWithoutMovieListStatsNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => MovieListCreateOrConnectWithoutMovieListStatsInput,
    {
      nullable: true,
    },
  )
  connectOrCreate?:
    | MovieListCreateOrConnectWithoutMovieListStatsInput
    | undefined;
  ...
  @TypeGraphQL.Field(
    (_type) => MovieListUpdateToOneWithWhereWithoutMovieListStatsInput,
    {
      nullable: true,
    },
  )
