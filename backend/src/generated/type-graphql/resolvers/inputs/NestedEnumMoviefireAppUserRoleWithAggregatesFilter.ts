...
@TypeGraphQL.InputType("NestedEnumMoviefireAppUserRoleWithAggregatesFilter", {})
export class NestedEnumMoviefireAppUserRoleWithAggregatesFilter {
  ...
  @TypeGraphQL.Field(
    (_type) => NestedEnumMoviefireAppUserRoleWithAggregatesFilter,
    {
      nullable: true,
    },
  )
