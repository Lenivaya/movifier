...
export class MovieUpdateManyWithoutInWatchlistByUsersNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieUpsertWithWhereUniqueWithoutInWatchlistByUsersInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieUpdateWithWhereUniqueWithoutInWatchlistByUsersInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieUpdateManyWithWhereWithoutInWatchlistByUsersInput],
    {
      nullable: true,
    },
  )
  updateMany?:
    | MovieUpdateManyWithWhereWithoutInWatchlistByUsersInput[]
    | undefined;
