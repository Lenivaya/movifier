...
export class MovieStudioUpdateManyWithoutMoviesNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieStudioUpsertWithWhereUniqueWithoutMoviesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieStudioUpdateWithWhereUniqueWithoutMoviesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieStudioUpdateManyWithWhereWithoutMoviesInput],
    {
      nullable: true,
    },
  )
