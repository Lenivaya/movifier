...
export class MovieRatingUpdateManyWithoutMovieNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieRatingUpsertWithWhereUniqueWithoutMovieInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieRatingUpdateWithWhereUniqueWithoutMovieInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieRatingUpdateManyWithWhereWithoutMovieInput],
    {
      nullable: true,
    },
  )
