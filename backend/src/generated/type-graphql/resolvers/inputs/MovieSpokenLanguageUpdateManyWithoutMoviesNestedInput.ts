...
export class MovieSpokenLanguageUpdateManyWithoutMoviesNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieSpokenLanguageUpsertWithWhereUniqueWithoutMoviesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieSpokenLanguageUpdateWithWhereUniqueWithoutMoviesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [MovieSpokenLanguageUpdateManyWithWhereWithoutMoviesInput],
    {
      nullable: true,
    },
  )
