...
@TypeGraphQL.InputType("MovieListUpdateInput", {})
export class MovieListUpdateInput {
  ...
  @TypeGraphQL.Field(
    (_type) => MovifierAppUserUpdateOneRequiredWithoutMovieListsNestedInput,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => MovieListStatsUpdateOneWithoutMovieListNestedInput,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => MovieListCommentUpdateManyWithoutMovieListNestedInput,
    {
      nullable: true,
    },
  )
