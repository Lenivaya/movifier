...
export class MovieReviewCrudResolver {
  ...
  async createOneMovieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => CreateOneMovieReviewArgs)
    args: CreateOneMovieReviewArgs,
  ): Promise<MovieReview> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyMovieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => DeleteManyMovieReviewArgs)
    args: DeleteManyMovieReviewArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movieReviews(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindManyMovieReviewArgs)
    args: FindManyMovieReviewArgs,
  ): Promise<MovieReview[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieReviewArgs)
    args: FindUniqueMovieReviewArgs,
  ): Promise<MovieReview | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getMovieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieReviewOrThrowArgs)
    args: FindUniqueMovieReviewOrThrowArgs,
  ): Promise<MovieReview | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByMovieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => GroupByMovieReviewArgs)
    args: GroupByMovieReviewArgs,
  ): Promise<MovieReviewGroupBy[]> {
  ...
  async updateManyMovieReview(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpdateManyMovieReviewArgs)
    args: UpdateManyMovieReviewArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
