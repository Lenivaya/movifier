...
export class MovieCrewMemberOnMovieCrudResolver {
  ...
  async createManyMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => CreateManyMovieCrewMemberOnMovieArgs)
    args: CreateManyMovieCrewMemberOnMovieArgs,
  ...
  async deleteManyMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => DeleteManyMovieCrewMemberOnMovieArgs)
    args: DeleteManyMovieCrewMemberOnMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => DeleteOneMovieCrewMemberOnMovieArgs)
    args: DeleteOneMovieCrewMemberOnMovieArgs,
  ...
  async movieCrewMemberOnMovies(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindManyMovieCrewMemberOnMovieArgs)
    args: FindManyMovieCrewMemberOnMovieArgs,
  ): Promise<MovieCrewMemberOnMovie[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieCrewMemberOnMovieArgs)
    args: FindUniqueMovieCrewMemberOnMovieArgs,
  ): Promise<MovieCrewMemberOnMovie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieCrewMemberOnMovieOrThrowArgs)
    args: FindUniqueMovieCrewMemberOnMovieOrThrowArgs,
  ): Promise<MovieCrewMemberOnMovie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => GroupByMovieCrewMemberOnMovieArgs)
    args: GroupByMovieCrewMemberOnMovieArgs,
  ): Promise<MovieCrewMemberOnMovieGroupBy[]> {
  ...
  async updateManyMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpdateManyMovieCrewMemberOnMovieArgs)
    args: UpdateManyMovieCrewMemberOnMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneMovieCrewMemberOnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpdateOneMovieCrewMemberOnMovieArgs)
    args: UpdateOneMovieCrewMemberOnMovieArgs,
  ): Promise<MovieCrewMemberOnMovie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
