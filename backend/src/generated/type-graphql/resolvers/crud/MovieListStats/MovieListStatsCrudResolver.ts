...
export class MovieListStatsCrudResolver {
  ...
  async aggregateMovieListStats(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => AggregateMovieListStatsArgs) args: AggregateMovieListStatsArgs): Promise<AggregateMovieListStats> {
  ...
  async createOneMovieListStats(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => CreateOneMovieListStatsArgs) args: CreateOneMovieListStatsArgs): Promise<MovieListStats> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyMovieListStats(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => DeleteManyMovieListStatsArgs) args: DeleteManyMovieListStatsArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstMovieListStats(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => FindFirstMovieListStatsArgs) args: FindFirstMovieListStatsArgs): Promise<MovieListStats | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstMovieListStatsOrThrow(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => FindFirstMovieListStatsOrThrowArgs) args: FindFirstMovieListStatsOrThrowArgs): Promise<MovieListStats | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findManyMovieListStats(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => FindManyMovieListStatsArgs) args: FindManyMovieListStatsArgs): Promise<MovieListStats[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
