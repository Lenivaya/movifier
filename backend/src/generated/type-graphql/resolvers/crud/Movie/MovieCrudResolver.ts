...
export class MovieCrudResolver {
  ...
  async aggregateMovie(
    ...
    @TypeGraphQL.Args((_type) => AggregateMovieArgs) args: AggregateMovieArgs,
  ...
  async createManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => CreateManyMovieArgs) args: CreateManyMovieArgs,
  ...
  async createOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => CreateOneMovieArgs) args: CreateOneMovieArgs,
  ): Promise<Movie> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => DeleteManyMovieArgs) args: DeleteManyMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => DeleteOneMovieArgs) args: DeleteOneMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindFirstMovieArgs) args: FindFirstMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movies(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindManyMovieArgs) args: FindManyMovieArgs,
  ): Promise<Movie[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieArgs) args: FindUniqueMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => FindUniqueMovieOrThrowArgs)
    args: FindUniqueMovieOrThrowArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => GroupByMovieArgs) args: GroupByMovieArgs,
  ...
  async updateManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpdateManyMovieArgs) args: UpdateManyMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpdateOneMovieArgs) args: UpdateOneMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => UpsertOneMovieArgs) args: UpsertOneMovieArgs,
  ): Promise<Movie> {
    const { _count } = transformInfoIntoPrismaArgs(info);
