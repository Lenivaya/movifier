...
export class MovifierAppUserRelationsResolver {
  ...
  async watchlist(
    @TypeGraphQL.Root() movifierAppUser: MovifierAppUser,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => MovifierAppUserWatchlistArgs)
    args: MovifierAppUserWatchlistArgs,
  ): Promise<Movie[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx)
      .movifierAppUser.findUniqueOrThrow({
        where: {
  ...
  async rating(
    ...
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => MovifierAppUserRatingArgs)
    args: MovifierAppUserRatingArgs,
  ): Promise<MovieRating[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx)
      .movifierAppUser.findUniqueOrThrow({
  ...
  async movieLists(
    ...
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => MovifierAppUserMovieListsArgs)
    args: MovifierAppUserMovieListsArgs,
  ): Promise<MovieList[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx)
      .movifierAppUser.findUniqueOrThrow({
  ...
  async movieListsComments(
    @TypeGraphQL.Root() movifierAppUser: MovifierAppUser,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args((_type) => MovifierAppUserMovieListsCommentsArgs)
    args: MovifierAppUserMovieListsCommentsArgs,
