...
export class MovieListRelationsResolver {
  ...
  async movies(@TypeGraphQL.Root() movieList: MovieList, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => MovieListMoviesArgs) args: MovieListMoviesArgs): Promise<Movie[]> {
  ...
  async MovieListStats(@TypeGraphQL.Root() movieList: MovieList, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => MovieListMovieListStatsArgs) args: MovieListMovieListStatsArgs): Promise<MovieListStats | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx).movieList.findUniqueOrThrow({
      where: {
        id: movieList.id,
  ...
  async movieListComments(@TypeGraphQL.Root() movieList: MovieList, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => MovieListMovieListCommentsArgs) args: MovieListMovieListCommentsArgs): Promise<MovieListComment[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx).movieList.findUniqueOrThrow({
      where: {
        id: movieList.id,
