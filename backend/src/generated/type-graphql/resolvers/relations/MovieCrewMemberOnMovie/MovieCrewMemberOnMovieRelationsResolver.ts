...
export class MovieCrewMemberOnMovieRelationsResolver {
  ...
  async movie(@TypeGraphQL.Root() movieCrewMemberOnMovie: MovieCrewMemberOnMovie, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo): Promise<Movie> {
  ...
  async crewMember(@TypeGraphQL.Root() movieCrewMemberOnMovie: MovieCrewMemberOnMovie, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo): Promise<MovieCrewMember> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx).movieCrewMemberOnMovie.findUniqueOrThrow({
      where: {
        movieId_movieCrewMemberId_movieCrewMemberTypeId: {
  ...
  async movieCrewMemberType(@TypeGraphQL.Root() movieCrewMemberOnMovie: MovieCrewMemberOnMovie, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo): Promise<MovieCrewMemberType> {
    const { _count } = transformInfoIntoPrismaArgs(info);
    return getPrismaFromContext(ctx).movieCrewMemberOnMovie.findUniqueOrThrow({
      where: {
        movieId_movieCrewMemberId_movieCrewMemberTypeId: {
