...
export class MovieCrewMemberRelationsResolver {
  ...
  async movies(@TypeGraphQL.Root() movieCrewMember: MovieCrewMember, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args(_type => MovieCrewMemberMoviesArgs) args: MovieCrewMemberMoviesArgs): Promise<MovieCrewMemberOnMovie[]> {
